...
SUCCESSFACTORS_LESSONS = {
    ...
    "required_markers_bleed_into_the_accessible_name": "On the candidate profile every REQUIRED "
        ...
        "' First Name' with a LEADING SPACE while optional 'Middle Name' has none. It is "
        "survivable — _resolve_ax_node strips both sides before comparing (main_server.py:190), "
        "verified rather than assumed — but DO NOT read the space as a required-detector: "
