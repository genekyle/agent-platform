...
@app.get("/api/application-answers")
...
@app.post("/api/application-answers")
...
@app.patch("/api/application-answers/{answer_key}")
...
@app.delete("/api/application-answers/{answer_key}")
...
@app.post("/api/application-answers/match")
...
@app.delete("/api/accounts/{account_id}/credentials")
